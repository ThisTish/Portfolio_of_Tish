...
const NavBar = () => {
  const linkClass = ({isActive}) => isActive ? "font-sans tracking-wider rounded-full flex items-center justify-center px-1 bg-secondary text-yellow " : "font-sans tracking-wider bg-transparent rounded-full lg:py-7  px-1 hover:bg-red hover:text-yellow"
