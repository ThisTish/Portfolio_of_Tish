...
const NavBar = () => {
  const linkClass = ({isActive}) => isActive ? "font-sans tracking-wider rounded-full  lg:py-8 px-1 bg-red text-yellow" : "font-sans tracking-wider bg-transparent rounded-full  lg:py-8 px-1 hover:bg-red hover:text-yellow"
