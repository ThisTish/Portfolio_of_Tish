...
const Education = () => {
  return (
    <div className="container border-green border-8 w-fit space-y-3 px-3 pb-14 -mt-9 -ml-8 rounded-3xl bg-highlight">
        ...
        <div className="ml-5 flex flex-col items-end text-secondary space-y-2">
          ...
          <p className=" font-semibold text-sm">
            UNIVERSITY OF UTAH FULL STACK | Salt Lake City
          </p>
        </div>
		</div>  
  )
