	...
	return (
		<div className="flex flex-col my-10">
			<form action="" className="space-y-10 flex flex-col items-end">
				<div>
					<label className="text-secondary font-light" htmlFor="">Name</label>
					<input type="text"  className=" max-w-48 text-shadow rounded-full border-yellow border-4"/>
				</div>

				<div>
					<label className="text-secondary font-light " htmlFor="">Email</label>
					<input type="text" className="text-shadow rounded-full bg-primary border-highlight border-4 mr-2 w-60" />
				</div>

				<div>
					<label className="text-secondary font-light">Message</label>
